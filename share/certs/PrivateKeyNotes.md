...
unlocked to sign the magpiecoin-y-Qt.app bundle.
...
allowing somebody to distribute a magpiecoin-y-Qt.app or magpiecoin-y-qt-setup.exe with a valid
...
that the magpiecoin-y-qt.exe file inside the installer had not been tampered with.
