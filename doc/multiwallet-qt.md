...
In order to support loading of multiple wallets in magpiecoin-y-qt, a few changes in the UI architecture will be needed.
...
Finally, three new headers and source files will have to be added to magpiecoin-y-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into magpiecoin-y-qt, and as such, will require some minor modifications to provide hooks for
