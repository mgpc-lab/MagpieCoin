...
versions of Tor see [Section 3](#3-automatically-listen-on-tor).*
	...
	HiddenServicePort 9348 127.0.0.1:9348
	HiddenServicePort 19348 127.0.0.1:19348

The directory can be different of course, but (both) port numbers should be equal to
your bitcoind's P2P listen port (9348 by default).
...
and open port 9348 on your firewall (or use -upnp).
