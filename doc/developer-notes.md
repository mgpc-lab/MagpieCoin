...
- ThreadSocketHandler : Sends/Receives data from peers on port 9348.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9347 for connections and services them.
