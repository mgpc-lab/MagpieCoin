...
- #8830 `ef0801b` test: Add option to run magpiecoin-util-test.py manually (jnewbery)
- #8881 `e66cc1d` Add some verbose logging to magpiecoin-util-test.py (jnewbery)
...
- #9023 `774db92` Add logging to magpiecoin-util-test.py (jnewbery)
- #9065 `c9bdf9a` Merge `doc/unit-tests.md` into `src/test/README.md` (laanwj)
- #9069 `ed64bce` Clean up bctest.py and magpiecoin-util-test.py (jnewbery)
...
### Documentation
- #9347 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
