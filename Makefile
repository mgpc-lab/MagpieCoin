...
pkgdatadir = $(datadir)/MagpieCoin
pkgincludedir = $(includedir)/MagpieCoin
pkglibdir = $(libdir)/MagpieCoin
pkglibexecdir = $(libexecdir)/MagpieCoin
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/magpiecoin_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/magpiecoin_qt.m4 \
	$(top_srcdir)/build-aux/m4/magpiecoin_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/magpiecoin-config.h
CONFIG_CLEAN_FILES = libmagpiecoinconsensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	...
	test/util/magpiecoin-util-test.py test/util/rpcauth-test.py
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libmagpiecoinconsensus.pc.in \
	...
	$(top_srcdir)/src/config/magpiecoin-config.h.in \
	$(top_srcdir)/test/config.ini.in \
	$(top_srcdir)/test/functional/test_runner.py \
	$(top_srcdir)/test/util/magpiecoin-util-test.py \
...
ACLOCAL = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/missing automake-1.15
...
COPYRIGHT_HOLDERS_FINAL = The MagpieCoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = MagpieCoin Core
COPYRIGHT_YEAR = 2021
CPP = gcc -E
...
MAGPIECOIN_CLI_NAME = magpiecoin-cli
MAGPIECOIN_DAEMON_NAME = magpiecoind
MAGPIECOIN_GUI_NAME = magpiecoin-qt
MAGPIECOIN_TX_NAME = magpiecoin-tx
MAINT = 
MAKEINFO = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = MagpieCoin
PACKAGE_BUGREPORT = https://github.com/mgpc-lab/MagpieCoin/issues
PACKAGE_NAME = MagpieCoin Core
PACKAGE_STRING = MagpieCoin Core 2.0.1
PACKAGE_TARNAME = MagpieCoin
PACKAGE_URL = http://magpiecoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/lds/MagpieCoin-2.0
abs_srcdir = /home/lds/MagpieCoin-2.0
abs_top_builddir = /home/lds/MagpieCoin-2.0
abs_top_srcdir = /home/lds/MagpieCoin-2.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/lds/MagpieCoin-2.0/build-aux/install-sh
...
pkgconfig_DATA = libmagpiecoinconsensus.pc
MAGPIECOIND_BIN = $(top_builddir)/src/$(MAGPIECOIN_DAEMON_NAME)$(EXEEXT)
MAGPIECOIN_QT_BIN = $(top_builddir)/src/qt/$(MAGPIECOIN_GUI_NAME)$(EXEEXT)
MAGPIECOIN_CLI_BIN = $(top_builddir)/src/$(MAGPIECOIN_CLI_NAME)$(EXEEXT)
MAGPIECOIN_TX_BIN = $(top_builddir)/src/$(MAGPIECOIN_TX_NAME)$(EXEEXT)
MAGPIECOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = MagpieCoin-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/magpiecoin.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/magpiecoin-cli.bash-completion \
	       $(top_srcdir)/contrib/magpiecoin-tx.bash-completion \
	       $(top_srcdir)/contrib/magpiecoind.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/magpiecoin.ico \
...
COVERAGE_INFO = baseline.info \
  test_magpiecoin_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_magpiecoin_coverage.info test_magpiecoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/magpiecoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MagpieCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) test/functional/test_runner.py \
	...
	test/util/magpiecoin-util-test.py \
	test/util/data/magpiecoin-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(MAGPIECOIN_WIN_INSTALLER)
...
src/config/magpiecoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/magpiecoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/magpiecoin-config.h
$(top_srcdir)/src/config/magpiecoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/magpiecoin-config.h src/config/stamp-h1
libmagpiecoinconsensus.pc: $(top_builddir)/config.status $(srcdir)/libmagpiecoinconsensus.pc.in
...
$(MAGPIECOIN_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MAGPIECOIND_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MAGPIECOIN_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MAGPIECOIN_CLI_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(MAGPIECOIN_TX_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/magpiecoin.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/MagpieCoin-Qt: all-recursive
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $(MAGPIECOIN_QT_BIN) $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MagpieCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MagpieCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#deploy: $(OSX_DMG)
#deploy: $(MAGPIECOIN_WIN_INSTALLER)

$(MAGPIECOIN_QT_BIN): FORCE
	$(MAKE) -C src qt/$(@F)

$(MAGPIECOIND_BIN): FORCE
	$(MAKE) -C src $(@F)

$(MAGPIECOIN_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)

$(MAGPIECOIN_TX_BIN): FORCE
	$(MAKE) -C src $(@F)
...
#test_magpiecoin.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_magpiecoin -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_magpiecoin_filtered.info: test_magpiecoin.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_magpiecoin_filtered.info
...
#test_magpiecoin_coverage.info: baseline_filtered.info test_magpiecoin_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_magpiecoin_filtered.info -o $@

#total_coverage.info: test_magpiecoin_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_magpiecoin_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_magpiecoin.coverage/.dirstamp:  test_magpiecoin_coverage.info
...
#cov: test_magpiecoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_magpiecoin.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
