...
static void SetupMagpieCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " magpiecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  magpiecoin-tx [options] <hex-tx> [commands]  Update hex-encoded magpiecoin transaction\n" +
            "or:     magpiecoin-tx [options] -create [commands]   Create hex-encoded magpiecoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded magpiecoin transaction
