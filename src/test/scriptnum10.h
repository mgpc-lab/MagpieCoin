...
#ifndef MAGPIECOIN_TEST_SCRIPTNUM10_H
#define MAGPIECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MagpieCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MAGPIECOIN_TEST_BIGNUM_H
