/* src/config/magpiecoin-config.h.  Generated from magpiecoin-config.h.in by configure.  */
/* src/config/magpiecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MAGPIECOIN_CONFIG_H

#define MAGPIECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The MagpieCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "MagpieCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mgpc-lab/MagpieCoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MagpieCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MagpieCoin Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "MagpieCoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://magpiecoin.org/"
