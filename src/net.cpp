...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("magpiecoin-y-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MagpieCoin " + FormatFullVersion();
...
static const char *strTestNetDNSSeed[][2] = {
    {"testnet.magpiecoin.org", "testnet-seeder.magpiecoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MagpieCoin is probably already running."), addrBind.ToString().c_str());
        else
