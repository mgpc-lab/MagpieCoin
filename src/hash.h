...
#include <uint256.h>
#include <version.h>
#include <crypto/yespowermgpc/yespower.h>
...
/** A hasher class for MagpieCoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for MagpieCoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
