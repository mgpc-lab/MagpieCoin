    ...
    mapper(0)
{
    ...
    ui->magpiecoinAtStartup->setToolTip(ui->magpiecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->magpiecoinAtStartup->setText(ui->magpiecoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openMagpieCoinConfButton->setToolTip(ui->openMagpieCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new MagpieCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->magpiecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMagpieCoinConfButton_clicked()
{
