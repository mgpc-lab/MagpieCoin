...
#ifndef MAGPIECOIN_QT_MAGPIECOINUNITS_H
#define MAGPIECOIN_QT_MAGPIECOINUNITS_H
...
/** MagpieCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MagpieCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MagpieCoinUnits(QObject *parent);

    /** MagpieCoin units.
      @note Source: https://en.magpiecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MGPC,
...
typedef MagpieCoinUnits::Unit MagpieCoinUnit;

#endif // MAGPIECOIN_QT_MAGPIECOINUNITS_H
