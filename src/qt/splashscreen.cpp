    ...
    QWidget(0, f), curAlignment(0), m_node(node)
{
    ...
    QSize splashSize(640*devicePixelRatio,480*devicePixelRatio);
    ...
    // draw the magpiecoin icon, expected size of PNG: 1024x1024
    QRect rectIcon(QPoint(-40,-30), QSize(400,400));
