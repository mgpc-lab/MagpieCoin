...
magpiecoind=${1}/magpiecoind
CLI=${1}/magpiecoin-y-cli
...
echo "Done, magpiecoind's shut down. To rerun/poke around:"
echo "${1}/magpiecoind -datadir=$D1 -daemon"
echo "${1}/magpiecoind -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall magpiecoind; rm -rf test.*"
exit 0
